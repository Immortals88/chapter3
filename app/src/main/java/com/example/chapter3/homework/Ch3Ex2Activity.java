...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator scale=ObjectAnimator.ofFloat(target,"ScaleX",1.0f,2.0f);
        scale.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        ...
        animatorSet.playTogether(animator1,scale,scaleY,alpha);
        animatorSet.start();
    }
}
